	...
	<tr>
		<td id="footer" colspan="3">
			...
			<div style="text-align:center;margin-bottom:15px"><a href="https://symbiota.org/" target="_blank">About Symbiota <img src="<?php echo $CLIENT_ROOT; ?>/images/layout/logo_symbiota.png" style="width:70px" /></a> <a href="https://biokic.github.io/symbiota-docs/" target="_blank">Guides and documentation</a></div>

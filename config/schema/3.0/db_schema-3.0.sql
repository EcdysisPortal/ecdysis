...
INSERT INTO `taxa`(tid,kingdomName,rankid,sciname,unitName1,unitName2,author) VALUES (1,'',1,'Organism','Organism',NULL,''),(2,'Monera',10,'Monera','Monera',NULL,''),(3,'Protista',10,'Protista','Protista',NULL,''),(4,'Plantae',10,'Plantae','Plantae',NULL,''),(5,'Fungi',10,'Fungi','Fungi',NULL,''),(6,'Animalia',10,'Animalia','Animalia',NULL,'');
INSERT INTO `taxstatus`(tid,tidAccepted,taxAuthID,parentTid) VALUES (1,1,1,1),(2,2,1,1),(3,3,1,1),(4,4,1,1),(5,5,1,1),(6,6,1,1);
